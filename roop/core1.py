...
def parse_args() -> None:
    ...
    program.add_argument('--output-video-encoder', help='encoder used for the output video', dest='output_video_encoder', default='libx265', choices=['libx264', 'libx265', 'libvpx-vp9', 'h264_nvenc', 'hevc_nvenc'])
